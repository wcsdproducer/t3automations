...
// We'll dynamically check the outbound public IP of this local machine so Namecheap accepts it.
...
async function main() {
  ...
  console.log('Existing hosts:', existingHosts);

  // 3. Update records:
  // Remove old root A records, www CNAME if it conflicts, and old fah-claim TXT records.
  ...
  existingHosts.push({
    Name: '@',
    Type: 'TXT',
    Address: 'fah-claim=002-02-a54e0416-0557-46c0-9931-26b7646d97a2',
    MXPref: '10',
    TTL: '1799'
  });
