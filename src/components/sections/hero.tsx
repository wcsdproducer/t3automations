...
export default function Hero() {
  ...
  return (
    <section className="relative flex items-center justify-center h-screen bg-background text-white">
      <div className="video-background">
        <iframe
          src="https://www.youtube.com/embed/wqQarWPIUQg?autoplay=1&mute=1&loop=1&playlist=wqQarWPIUQg&controls=0&showinfo=0&autohide=1&modestbranding=1&vq=hd1080"
          frameBorder="0"
