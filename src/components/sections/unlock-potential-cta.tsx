    ...
    return (
        <section className="bg-[#81ADBB] py-20">
            <div className="container text-center text-[#F5F0E7]">
                <h2 className="text-3xl font-bold tracking-tight sm:text-4xl"><TranslatedText>Unlock Your Potential</TranslatedText></h2>
                <p className="mt-4 text-lg"><TranslatedText>Transform Your Business with Our AI Solutions</TranslatedText></p>
