...
export function PestControlTemplate({
  ...
  return (
    <div className="bg-slate-50 text-slate-900 font-sans antialiased">
      ...
      <main>
        {/* Hero Section */}
        <section className="relative py-16 lg:py-24 px-6 md:px-12 bg-gradient-to-br from-emerald-50/50 to-white overflow-hidden border-b border-slate-100">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              <Badge className="bg-emerald-500/10 hover:bg-emerald-500/10 text-emerald-800 border-none font-bold text-xs uppercase px-3 py-1 tracking-wider">
            ...
            <div className="lg:col-span-5 relative w-full aspect-[4/3] sm:aspect-video lg:aspect-square rounded-2xl overflow-hidden shadow-2xl shadow-emerald-950/10 border border-slate-100 bg-slate-100">
              {content.images?.hero && content.images.hero.length > 0 ? (
                ...
                <div className="flex h-full items-center justify-center bg-slate-200">
                  <Bug className="h-16 w-16 text-emerald-300" />
                </div>
              )}
            </div>
          </div>
        ...
        <section id="services" className="py-16 md:py-24 px-6 md:px-12 bg-white">
          <div className="max-w-7xl mx-auto space-y-12">
            <div className="text-center space-y-4">
              <Badge className="bg-emerald-500/10 hover:bg-emerald-500/10 text-emerald-800 border-none font-bold text-xs uppercase px-3 py-1">
                🛡️ Complete Defense
              </Badge>
        ...
        <section className="bg-emerald-950 text-white py-12 px-6 text-center border-t border-emerald-900">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {uniqueReviews.slice(0, 3).map((review: any, idx: number) => (
                <div key={idx} className="p-6 bg-slate-50 border border-slate-100 rounded-xl relative space-y-4 flex flex-col justify-between">
                  ...
                  <span className="text-xs font-bold text-emerald-950 block">{review.author}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <footer className="bg-slate-900 text-slate-400 py-12 px-6 md:px-12 border-t border-slate-850">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <p className="text-xs text-slate-550">© {new Date().getFullYear()} {companyName}. All rights reserved. Child-and-pet-safe local pest treatments.</p>
        </div>
      </footer>
